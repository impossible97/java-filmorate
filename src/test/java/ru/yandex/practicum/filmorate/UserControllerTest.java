...
class UserControllerTest {
    ...
    void validateUserFail() {
        ...
        user.setLogin("");
        exception.ValidationException exception = assertThrows(exception.ValidationException.class, () -> userController.validate(user));
        assertEquals("Логин не может быть пустым и содержать пробелы", exception.getMessage());


        user.setLogin("userLogin");
        user.setEmail("");
        exception = assertThrows(exception.ValidationException.class, () -> userController.validate(user));
